...
var nudgeButton = document.getElementById("send-nudge");
...
function scrollToBottom() {
  ...
  var lastMessageHeight = newMessage.previousElementSibling
...
socket.on("nudgeRoom", function(user) {
  document.body.classList.add('nudge-animation');
  setTimeout(function(){
    document.body.classList.remove('nudge-animation');
  }, 1000);
});
